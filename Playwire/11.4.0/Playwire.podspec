Pod::Spec.new do |s|
  ...
  s.subspec "Total" do |ss|
    ...
    ss.vendored_frameworks = 'sdks/Playwire_NonCOPPA.xcframework'
    ss.preserve_paths = 'sdks/Playwire_NonCOPPA.xcframework/*'

    ss.dependency 'AmazonPublisherServicesSDK', '5.1.0'
    ss.dependency 'PrebidMobile', '3.0.2'

    ss.dependency 'GoogleMobileAdsMediationFyber', '8.3.6.0'
    ss.dependency 'GoogleMobileAdsMediationPangle', '7.1.1.1.0'
    ...
    ss.dependency 'AppLovinMediationByteDanceAdapter', '7.1.1.1.0'
    ss.dependency 'PrebidMobileMAXAdapters', '3.0.2'
    ...
    s.pod_target_xcconfig = {
        'OTHER_SWIFT_FLAGS[config=*][sdk=*][arch=*]' => '"$(inherited) -no-verify-emitted-module-interface"'
    }
